...
@section('content')
    ...
    <form action=" {{ route('users.index') }} " method="get" class="py-5">
        ...
        class="md:w-1/6 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 
    ...
    <table class="min-w-full leading-normal shadow-md rounded-lg overflow-hidden">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <a href="{{ route('users.show', $user->id) }}" class="bg-blue-200 rounded-full py-2 px-6">Detalhes</a>
                </td>
